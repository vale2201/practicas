...
def enviar_email(nombre):
    ...
    msg = MIMEMultipart()
    mensaje = 'Ahi esrá tu regalito'
    msg['From'] = 'valemto2021@gmail.com'
    msg['To'] = 'valemto2021@gmail.com'
    msg['Subject'] = 'Deberes de informatica'
    ...
    server.starttls()
    server.login(msg['From'], 'Valeria2201')
...
def mover_fichero():
    ...
    final_path = 'C:\\Users\\{}'.format(USER_NAME)
